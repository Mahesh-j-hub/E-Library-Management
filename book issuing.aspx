<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="book issuing.aspx.cs" Inherits="Elibrary_management.book_issuing" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <asp:Button ID="Button3" CssClass="btn btn-lg btn-block btn-danger"  runat="server" Text="Delete" />
                            </div>
