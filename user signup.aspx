<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="user signup.aspx.cs" Inherits="Elibrary_management.user_signup" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox7" runat="server" placeholder="Pin Code" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button ID="Button3" runat="server" class="btn btn-success btn-block btn-lg" OnClick="Button3_Click" runat="server" Text="Sign Up" />
                                </div>
                            </div>
                        </div>
                    </div>  
